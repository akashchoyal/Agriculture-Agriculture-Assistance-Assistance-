...
const styles = StyleSheet.create({ root: { flex: 1 }, nav: { minHeight: Platform.OS === "web" ? 73 : 70, borderTopWidth: 1, flexDirection: "row", justifyContent: "space-around", alignItems: "center", paddingHorizontal: 8 }, navItem: { minWidth: 64, minHeight: 54, alignItems: "center", justifyContent: "center", gap: 3 }, navIcon: { width: 38, height: 30, borderRadius: 12, alignItems: "center", justifyContent: "center" }, navLabel: { fontSize: 10 } });