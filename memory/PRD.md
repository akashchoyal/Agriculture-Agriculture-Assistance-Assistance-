...
- 2026-08-29: Added a cinematic KrishiAI startup screen with the exact owner credit “Akash Choyal,” animated brand/credit entrance, safe-area-aware placement, and a minimum display window that preserves session restoration before transitioning to login or the main app.

## Prioritized backlog
- P0: Monitor AI response cost/latency and add rate limiting before high-volume use.
- P1: Add field-specific weather history charts and distance-ranked mandi results when market coordinates are available.
- P2: Add push notifications and offline queueing for low-connectivity farms.
