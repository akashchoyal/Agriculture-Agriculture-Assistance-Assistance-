...
export const copy = {
  en: {
    ...
    aiModel: "AI model", geminiPrimary: "Gemini 3 Flash · GPT fallback", active: "Active", keyboardSettings: "Typing keyboard", keyboardSettingsSubtitle: "Hindi, English, emoji and key preferences",
  },
  hi: {
    ...
    aiModel: "AI मॉडल", geminiPrimary: "Gemini 3 Flash · GPT बैकअप", active: "चालू", keyboardSettings: "टाइपिंग कीबोर्ड", keyboardSettingsSubtitle: "हिंदी, English, emoji और key की पसंद",
  },
} as const;
